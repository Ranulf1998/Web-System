...
<body class="bg-gradient-to-br from-[#f8f4ee] via-[#f6efe6] to-[#efe6d9] text-[#1c1b16] min-h-screen">
    <div class="relative overflow-hidden" x-data="{ plansOpen: false }" @keydown.escape.window="plansOpen = false">
            ...
            <nav class="flex flex-wrap items-center justify-between gap-4">
                ...
                <div class="flex flex-wrap items-center gap-3 text-sm">
                    <form method="GET" action="{{ url('/shop-login') }}" class="flex items-center gap-2 rounded-full bg-white/70 px-3 py-2 shadow-sm ring-1 ring-[#e6d9c7]">
                        ...
                        <button type="submit" class="rounded-full bg-[#1c1b16] px-3 py-1 text-xs font-semibold text-white">Login</button>
                    </form>
        ...
        <main class="mx-auto w-full max-w-6xl px-6 pb-16 pt-12 lg:px-10">
            <div class="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                <div class="space-y-6">
                    <div class="inline-flex items-center gap-2 rounded-full bg-white/70 px-4 py-1 text-xs uppercase tracking-[0.3em] text-[#7d6d5a] ring-1 ring-[#e6d9c7]">
                    ...
                    <div class="rounded-[32px] bg-[#1c1b16] p-6 text-white shadow-2xl">
                        ...
                        <div class="mt-6 grid gap-3">
                            <div class="rounded-2xl bg-white/10 p-4">
                                <div class="text-xs uppercase tracking-wide text-[#d5c1aa]">Top seller</div>
                            ...
                            <div class="rounded-2xl bg-white/10 p-4">
                                <div class="text-xs uppercase tracking-wide text-[#d5c1aa]">Inventory alert</div>
                                <div class="mt-2 flex items-center justify-between">
            ...
            <section class="mt-16 grid gap-6 lg:grid-cols-[0.45fr_0.55fr]">
                <div class="rounded-3xl bg-white/80 p-6 shadow-sm ring-1 ring-[#e6d9c7]">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="rounded-3xl bg-white/90 p-5 shadow-sm ring-1 ring-[#e6d9c7]">
